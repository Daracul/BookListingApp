...
public class Utils {
    ...
    private static ArrayList<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            JSONObject rootJSON = new JSONObject(bookJSON);
            ...
            for (int i=0; i < itemsJSON.length(); i++){
                ...
                books.add(new Book(authorsSB.toString(), title , description, imageUrl));
